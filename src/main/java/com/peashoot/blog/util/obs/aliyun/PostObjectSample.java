package com.peashoot.blog.util.obs.aliyun;
...
public class PostObjectSample {
    ...
    private void postObject() throws Exception {
        ...
        // 设置回调服务器地址，如http://obs-demo.aliyuncs.com:23450或http://127.0.0.1:9090。
    ...
    private static String formUpload(String urlStr, Map<String, String> formFields, String localFile)
        ...
        String boundary = UUID.randomUUID().toString().replace("-", "").substring(8, 24);
        try {
